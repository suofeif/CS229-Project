...
if __name__ == '__main__':
    ...
    #train data text tokenization using Jieba
    ...
    # RBF svm model train: column by column (each with a model)
    logger.info("start train model")
    classifier_dict = dict()
    for column in columns[2:]:
        label_train = train_data_df[column] #get label of one column
        ...
        classifier_dict[column] = text_classifier #store model to dict
